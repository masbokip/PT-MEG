...
export default function ProductList() {
  ...
  const fetchProductData = async (query = "") => {
    try {
      const response = await axios.get(`${testURL}/api/productsMUR`, {
        params: { search: query },
      });
          ...
          <ul className={`lg:flex space-x-4 ${isMenuOpen ? 'block' : 'hidden'}`}>
            ...
            <li>
              <Link href="/product/filter/termahal">
                <p className="text-blue-900 items-center">Termurah</p>
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/product/filter/za">
              <p className="flex hover:text-blue-600">
              Nama 
             </p>
              </Link>
            </li>
