...
export default function Index() {
  ...
  return (
    ...
    <div class="mx-auto grid w-full px-15 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-0 xl:gap-0 p-10 bg-white">
      <div class="content-center justify-self-start md:col-span-7 md:text-start bg-white">
        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight  md:max-w-2xl md:text-5xl xl:text-6xl text-black bg-white">PT Megah Era Gunakarya <br />Gunakarya</h1>
        <p class="mb-4 max-w-2xl text-gray-500 md:mb-12 md:text-lg lg:mb-5 lg:text-xl bg-white">Kami menawarkan solusi elektrikal yang andal dan menjangkau seluruh wilayah Indonesia dengan mudah.</p>
      </div>
      <div class="hidden md:col-span-5 md:mt-0 md:flex bg-white">
    ...
    <section className="bg-gray-50 py-8 antialiased  md:py-12">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
          <div>
            <h2 className="mt-3 text-xl font-semibold text-gray-900 sm:text-2xl">Produk Baru</h2>
          </div>
        </div>
                          ...
                          {productData.map(product => (
                            <div key={product.id_produk} className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                  ...
                                  <img
                                    ...
                                    onClick={() => {
                                      if (!session) {
                                        ...
                                        handleDetail(product.id_produk);
                                      }
                                    }}
                              ...
                              <div className="pt-6">
                                  ...
                                  <button
                                          ...
                                          onClick={() => {
                                            if (!session) {
                                              ...
                                              addToCartSingle(product.id_produk);
                                            }
                                          }}
                                        >
                                          <span className="sr-only cursor-pointer">Add to Cart</span>
                                          <FaCartShopping className="h-5 w-5" disabled={product.stok <= 0} />
                                        </button>
                                        ...
                                        <button
                                          ...
                                          onClick={() => {
                                            if (!session) {
                                              ...
                                              addToFavorite(product.id_produk);
                                            }
                                          }}
                                        >
                                ...
                                <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline" onClick={() => 
                                  {
                                    if (!session) {
                                      Swal.fire({
                                        icon: 'warning',
      ...
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
          <div>
            <h2 className="mt-3 text-xl font-semibold text-gray-900 sm:text-2xl">Promo Produk</h2>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
                              ...
                              <div className="pt-6">
                                <div className="mb-4 flex items-center justify-between gap-4">
                                  <div className="flex items-center justify-end gap-1">
                                    ...
                                    >
                                      <span className="sr-only cursor-pointer">Add to Cart</span>
                                      <FaCartShopping className="h-5 w-5" onClick={() => {
                                            if (!session) {
                                              Swal.fire({
                                                icon: 'warning',
                                                title: 'Login Required',
                                ...
                                <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline  cursor-pointer" onClick={() => {
                                      if (!session) {
                                        Swal.fire({
                                          icon: 'warning',
                                          title: 'Login Required',
