...
export default function Page() {
    ...
    const fetchData = async (query = "") => {
      try {
        const response = await axios.get(`${testURL}/api/users`, {
          params: { search: query },
        });
     ...
     <nav className="rounded-lg border border-gray-800 bg-gray-900 p-4 shadow-lg mt-5">
      ...
      <div className="flex items-center space-x-4">
        ...
        <ul className="flex space-x-4 mx-6">
          <li>
            <Link href="/user">
              <p className="text-green-400">Semua User</p>
            </Link>
          </li>
          <li>
            <Link href="/user/customer">
              <p className="hover:text-green-400">Role</p>
            </Link>
          </li>
          <li>
            <Link href="/user/all/filter/az">
              <p className="hover:text-green-400">Nama</p>
            </Link>
          </li>
          <li>
            <Link href="/user/all/filter/new">
