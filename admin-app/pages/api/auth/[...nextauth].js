  ...
  callbacks: {
    async jwt({ token, user }) {
      if (user) {
        ...
        token.nama_depan = user.nama_depan;
        token.nama_belakang = user.nama_belakang;
    ...
    async session({ session, token }) {
      ...
      session.user.nama_depan = token.nama_depan;
      session.user.nama_belakang = token.nama_belakang;
